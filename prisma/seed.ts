...
async function main() {
  ...
  // ─── Admin User ──────────────────────────────────────────────
  const passwordHash = await bcrypt.hash('GCBSadmin1234!', 12)
  ...
  const heroes = [
    {
      ...
      bodyText: 'Learn the art and science of cafe from industry professionals. Our hands-on training prepares students for careers in cafés, restaurants, hotels, and cafe businesses.',
  ...
  const categories = [
    ...
    { name: 'Barista Skills',  slug: 'barista-skills',  description: 'Cafe extraction, latte art, and barista fundamentals' },
    { name: 'Operations',      slug: 'operations',      description: 'Day-to-day café operations and team management' },
    { name: 'Roasting',        slug: 'roasting',        description: 'Green bean sourcing and cafe roasting science' },
  ...
  const courses = [
    {
      ...
      description: `The Diploma in Café Management is our flagship programme designed for aspiring café owners and managers. Over 12 intensive months, students gain comprehensive skills across cafe science, business management, financial planning, staff management, and customer experience design.\n\nThis programme combines classroom learning with real-world practice sessions in our state-of-the-art cafe lab, producing graduates who are genuinely café-ready from their first day of work.`,
      duration: '12 months',
      durationWeeks: 52,
      level: 'DIPLOMA',
      localFee: 8500,
      ...
      curriculum: [
        { module: 'Module 1: Cafe Fundamentals', topics: ['Cafe origins & varietals', 'Roast profiles', 'Sensory evaluation', 'Water chemistry'] },
    ...
    },
    {
      ...
      curriculum: [
        { module: 'Module 1: Cafe Origins', topics: ['World cafe regions', 'Processing methods', 'Green bean grading'] },
      ...
      outcomes: [
        ...
        'Understand and apply cafe sensory evaluation',
        'Operate all common commercial espresso equipment',
      ],
      careerPaths: ['Head Barista', 'Barista Trainer', 'Cafe Educator', 'Café Supervisor', 'Competition Barista'],
      isFeatured: true,
      isActive: true,
      sortOrder: 2,
    },
    ...
    },
    {
      ...
      title: 'Cafe Roasting & Sourcing',
      slug: 'coffee-roasting-sourcing',
      tagline: 'From bean to cup — the complete journey',
      description: 'An intensive 3-month deep-dive into the world of specialty cafe sourcing and roasting. Students visit origin farms (virtually and in-person), learn green bean evaluation, and master drum and air roasting on commercial equipment.',
      duration: '3 months',
      durationWeeks: 13,
      level: 'CERTIFICATE',
      localFee: 3200,
      ...
      careerPaths: ['Cafe Roaster', 'Green Cafe Buyer', 'Sensory Analyst', 'Roastery Manager'],
      isFeatured: true,
      isActive: true,
      sortOrder: 4,
    },
    {
      ...
      careerPaths: ['Café Group Founder', 'F&B Director', 'Cafe Brand Manager', 'Hospitality Entrepreneur'],
      isFeatured: true,
      isActive: true,
      sortOrder: 5,
    },
  ...
  const testimonials = [
    ...
    },
    {
      ...
      quote: 'I came in knowing nothing about cafe. GCBS transformed me into a confident café owner. The business modules alone are worth the entire programme.',
  ...
  const gallery = [
    {
      title: 'Cafe Lab', category: 'COFFEE_LAB',
      ...
      altText: 'Students training in the GCBS cafe lab',
      isActive: true, sortOrder: 1,
    },
    {
    ...
    {
      title: 'Cafe Roasting', category: 'COFFEE_LAB',
      ...
      altText: 'Cafe roasting class in session',
      isActive: true, sortOrder: 4,
    },
    {
